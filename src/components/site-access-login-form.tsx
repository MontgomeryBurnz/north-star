...
export function SiteAccessLoginForm({ redirectTo }: { redirectTo: string }) {
  ...
  return (
    <main className="mx-auto flex min-h-[calc(100vh-12rem)] max-w-7xl items-center justify-center px-4 py-16 sm:px-6 lg:px-8">
      <Card className="w-full max-w-md bg-zinc-950/85">
