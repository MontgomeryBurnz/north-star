            ...
            content: [
              {
                ...
                text: [
                  ...
                  "Every plan must be directly shaped by the freshest grounded inputs available: uploaded artifacts and extracted text, active-program updates, Delivery Board cards and attachments, role-based team submissions, and leadership feedback.",
                  "Treat these inputs as the authoritative evidence base. Do not ignore them when they are present.",
                  "Role-level statuses (On track, At risk, Blocked), Delivery Board card statuses, attachments, and any needsLeadershipAttention flags are part of the authoritative operating posture. Reflect them explicitly in role guidance, risk posture, and escalation language.",
